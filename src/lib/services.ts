...
export const services: Service[] = [
  {
    ...
    description: "Conjunto de manobras terapêuticas que atuam diretamente sobre o sistema muscular, promovendo relaxamento profundo, alívio de tensões acumuladas e melhoria da circulação sanguínea.",
    longDescription: [
    ...
    indications: ["Dores musculares crónicas", "Stress e ansiedade", "Tensão na cervical e lombar", "Fadiga geral"],
    duration: "50 min",
  ...
  },
  {
    ...
    description: "Técnica milenar que utiliza a inserção de agulhas finíssimas em pontos específicos do corpo para restaurar o fluxo de energia (Qi), promovendo a cura e o alívio da dor.",
    longDescription: [
    ...
    indications: ["Dores crónicas (costas, pescoço, articulações)", "Enxaquecas e dores de cabeça", "Ansiedade, stress e insónias", "Desordens digestivas e hormonais"],
    duration: "60 min",
  ...
  },
  {
    ...
    description: "Abordagem holística que diagnostica e trata disfunções de mobilidade dos tecidos do corpo humano, restabelecendo o equilíbrio mecânico e prevenindo lesões.",
    longDescription: [
    ...
    indications: ["Dores de coluna (lombalgias, cervicalgias)", "Dores articulares (ombros, joelhos)", "Alterações posturais", "Lesões desportivas e ciáticas"],
    duration: "60 min",
  ...
  },
  {
    ...
    description: "Técnica da Medicina Tradicional Chinesa que utiliza ventosas para criar vácuo, libertando tensões musculares profundas, estimulando a circulação e desintoxicando os tecidos.",
    longDescription: [
    ...
    indications: ["Dores musculares e articulares agudas ou crónicas", "Contraturas e rigidez", "Fadiga física e sobrecarga desportiva", "Problemas respiratórios leves"],
    duration: "45 min",
  ...
  },
  {
    ...
    description: "Massagem manual suave e rítmica que ativa o sistema linfático, reduz a retenção de líquidos, alivia o inchaço e devolve leveza ao corpo, desintoxicando o organismo.",
    longDescription: [
  ...
  },
  {
    ...
    description: "Tecnologia de ultrassom microfocalizado que estimula a produção natural de colagénio em camadas profundas, devolvendo firmeza ao rosto, pescoço e corpo.",
    longDescription: [
