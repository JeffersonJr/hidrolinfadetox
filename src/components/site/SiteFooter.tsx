      ...
      <div className="container-narrow grid gap-12 py-16 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-6 max-w-md text-sm leading-relaxed text-muted-foreground">
            {t("Tratamentos estéticos e terapêuticos de excelência em Portugal e Europa. Uma experiência clean, elegante e personalizada para o seu bem-estar.")}
          </p>
        </div>

        <div>
          <h4 className="text-xs uppercase tracking-[0.25em] text-gold">{t("Navegar")}</h4>
          <ul className="mt-5 space-y-3 text-sm">
            <li><Link to="/sobre" className="hover:text-gold">{t("Sobre")}</Link></li>
            <li><Link to="/servicos" className="hover:text-gold">{t("Serviços")}</Link></li>
            <li><Link to="/precos" className="hover:text-gold">{t("Preços")}</Link></li>
            <li><Link to="/contactos" className="hover:text-gold">{t("Contactos")}</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="text-xs uppercase tracking-[0.25em] text-gold">{t("Contacto")}</h4>
