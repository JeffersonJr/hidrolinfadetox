  ...
  head: () => ({
    meta: [
      { title: "Sobre · Tatiane Penteado" },
      {
        name: "description",
        content:
          "Conheça Tatiane Penteado — especialista em terapias integrativas e estética avançada em Portugal e Europa.",
      },
    ],
  }),
  component: AboutPage,
...
const values = [
  {
    ...
    text: "Cada protocolo nasce da escuta atenta e do respeito pela história única de cada cliente.",
  },
  {
    icon: Sparkles,
    title: "Resultados reais",
    text: "Equipamentos de última geração e técnicas validadas, sempre alinhadas a expectativas claras.",
  },
  {
    icon: Globe2,
    title: "Visão internacional",
    text: "Atuação consolidada em Portugal e formações em diversos países da Europa.",
  },
];
...
const credentials = [
  {
    ...
    text: "Cursos avançados em centros de referência no Brasil, Portugal e Europa.",
  },
  {
    icon: Award,
    title: "Certificações técnicas",
    text: "Especialista em terapias integrativas, medicina tradicional chinesa e tecnologias de estética avançada.",
  },
];
        ...
        <div className="grid gap-14 md:grid-cols-5 md:gap-20">
          ...
          <div className="md:col-span-3">
            <SectionHeading
              ...
              title={
                <>
                  Cuidar é a minha <em className="text-gold">vocação</em>.
                </>
              }
            ...
            <div className="mt-10 space-y-5 text-base leading-relaxed text-muted-foreground">
              <p>
                {t(
                  "Acredito profundamente que a verdadeira saúde e a vitalidade de cada pessoa começam no seu interior. É com base nesta convicção que tenho dedicado mais de 30 anos da minha vida profissional ao estudo e à prática das Terapias Integrativas, da Medicina Tradicional Chinesa (MTC) e da Osteopatia.",
                )}
              </p>
              <p>
                {t(
                  "A minha abordagem assenta num princípio fundamental: o nosso corpo funciona como um todo. Quando promovemos o reequilíbrio energético, estrutural e fisiológico, estamos a tratar a raiz dos problemas e não apenas os seus sintomas. Esta visão 'de dentro para fora' garante resultados muito mais profundos e duradouros na saúde de cada cliente.",
                )}
              </p>
              <p>
                {t(
                  "Neste contexto, a estética avançada — embora parte essencial dos meus protocolos — surge como a consequência natural e visível de um organismo curado e em harmonia. Uma pele radiante e um corpo modelado são reflexos de um metabolismo desintoxicado e de uma mente em equilíbrio.",
                )}
              </p>
              <p>
                {t(
                  "Através de um atendimento altamente personalizado e humano, procuro aliar as mais valiosas técnicas naturais milenares à tecnologia de ponta para proporcionar uma experiência transformadora, promovendo a autoestima e o bem-estar sustentável.",
                )}
              </p>
              <p className="font-medium text-primary">
                {t(
                  "Mais do que tratamentos, ofereço um espaço de cura, confiança e dedicação integral para que se sinta bem consigo mesma todos os dias.",
                )}{" "}
                ✨<br />
                <span className="mt-2 block">
                  {t(
                    "Desde 1994 a transformar saúde interior em beleza exterior.",
                  )}{" "}
                  💖
                </span>
              </p>
              <p className="italic">
                {t(
                  "Sigo em constante aperfeiçoamento, sempre aberta para aprender mais, de forma a qualificar-me com eficiência, eficácia e, acima de tudo, com sensibilidade humana.",
                )}
              </p>
            </div>
      ...
      <section className="bg-cream py-20 md:py-28">
        <div className="container-narrow">
          <SectionHeading
            ...
            title={
              <>
                Beleza que nasce do <em className="text-gold">equilíbrio</em>.
              </>
            }
        ...
        <SectionHeading
          ...
          title={
            <>
              ...
              <em className="text-gold">propósito</em>.
            </>
          }
      ...
      <section className="bg-primary py-24 text-primary-foreground">
        <div className="container-narrow text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl font-serif text-3xl leading-snug md:text-4xl">
            “Acredito que a verdadeira beleza está no equilíbrio entre cuidar de
            quem se é por dentro através de terapias naturais e revelar a melhor
            versão por fora.”
          </p>
          <p className="mt-8 text-[24px] uppercase tracking-[0.4em] text-secondary">
            Tatiane Penteado
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-14 md:grid-cols-2">
          <div>
            <SectionHeading
              ...
              title={
                <>
                  Conhecimento que se traduz em{" "}
                  <em className="text-gold">resultado</em>.
                </>
              }
          ...
          <div className="space-y-8">
            {credentials.map((c) => (
              <div
                key={c.title}
                className="flex items-start gap-5 border-b border-border pb-8"
              >
                <c.icon
