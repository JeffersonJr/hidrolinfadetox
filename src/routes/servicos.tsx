  ...
  head: () => ({
    meta: [
      { title: "Serviços · Hidrolinfa Detox" },
      {
        name: "description",
        content:
          "HIFU facial e corporal, drenagem linfática, ventosaterapia, massagens e mais — tratamentos de estética e bem-estar.",
      },
    ],
  }),
    ...
    <Layout>
      <section className="container-narrow py-20 md:py-24">
        <SectionHeading
          ...
          title={
            <>
              Tratamentos para corpo, rosto e{" "}
              <em className="text-gold">alma</em>.
            </>
          }
          ...
          <SectionHeading
            ...
            title={
              <>
                ...
                <em className="text-gold">{t("Chinesa & Bem-Estar")}</em>
              </>
            }
            description={t(
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <h4 className="font-serif text-xl text-primary font-medium">
                    {t(therapy.title)}
                  </h4>
                </div>
        ...
        <div className="container-narrow">
          <div className="mx-auto flex max-w-4xl flex-col items-center border border-border/60 bg-background px-6 py-16 text-center md:px-16 md:py-20">
            ...
            <h2 className="mt-6 font-serif text-3xl leading-tight text-primary md:text-5xl">
              Não sabe qual o <em className="text-gold">tratamento</em> ideal
              para si?
            </h2>
            <p className="mt-6 max-w-xl text-sm leading-relaxed text-muted-foreground">
              Agende uma consulta de avaliação. Analisamos as suas necessidades
              específicas e desenhamos um plano de tratamento 100% à medida,
