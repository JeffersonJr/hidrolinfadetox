...
function HomePage() {
  ...
  const imagensMomentosObj = import.meta.glob(
    "../assets/momentos/*.{png,jpg,jpeg,webp,avif}",
        ...
        <div className="container-narrow grid gap-14 py-20 md:grid-cols-2 md:gap-16 md:py-28">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-7 max-w-md text-base leading-relaxed text-muted-foreground">
              {t(
                "Sou Tatiane Penteado, especialista em terapias integrativas e estética avançada. Um espaço dedicado a revelar a sua melhor versão, com protocolos exclusivos e atendimento personalizado.",
              )}
            </p>
          ...
          {[
            {
              ...
              text: "Métodos integrativos para corpo e mente.",
            },
            {
              icon: HeartHandshake,
              title: "Atendimento humano",
              text: "Acompanhamento atento em cada sessão.",
            },
            {
              icon: Sparkles,
              title: "Estética avançada",
              text: "Tecnologia de ponta com protocolos personalizados.",
            },
          ].map((p) => (
      ...
      <section className="py-20 md:py-24 bg-background border-y border-border/50">
        <div className="container-narrow px-6 md:px-16">
          <SectionHeading
            ...
            title={
              <>
                <Translate>Momentos de </Translate>
                <em className="text-gold">
                  <Translate>Excelência</Translate>
                </em>
              </>
            }
            description={t(
              "Registos de encontros, formações e congressos que enriquecem a nossa prática, como a participação ao lado do Dr. Peter Mendel.",
            )}
          />
          <div className="mt-16 relative">
            ...
            >
              <CarouselContent className="-ml-2 md:-ml-4">
                {imagensMomentos.length > 0
                  ? imagensMomentos.map((imgUrl, i) => (
                      <CarouselItem
                        key={i}
                      ...
                      >
                        <div className="aspect-square bg-muted/50 border border-border/60 flex flex-col items-center justify-center text-center p-4 transition-colors hover:border-gold/60 cursor-pointer">
                          ...
                          <p className="text-[10px] uppercase text-muted-foreground">
                            {t("Adicione fotos na pasta")} src/assets/momentos
                          </p>
                        </div>
                      </CarouselItem>
                    ))}
        ...
        <div className="container-narrow">
          <div className="flex items-end justify-between gap-10">
            <SectionHeading
              ...
              title={
                <>
                  <Translate>Protocolos pensados para si.</Translate>
                </>
              }
              description={t(
            ...
            <Link
              to="/servicos"
              className="hidden text-sm tracking-wide text-primary hover:text-gold md:inline-flex md:items-center md:gap-2"
            >
              {t("Ver todos")}{" "}
            ...
            {services.map((s) => (
              <article key={s.slug} className="group">
                ...
                <Link
                  to="/servicos"
                  hash={s.slug}
                  className="mt-4 inline-flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-gold"
                >
                  {t("Saber mais")}{" "}
        ...
        <div className="container-narrow grid gap-14 md:grid-cols-5 md:gap-20">
          ...
          <div className="md:col-span-3">
            <SectionHeading
              ...
              title={
                <>
                  <Translate>Cuidar é a minha vocação.</Translate>
                </>
              }
            />
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
              <p>
                {t(
                  "A verdadeira saúde e vitalidade começam no nosso interior. É com esta convicção que dedico o meu trabalho às Terapias Integrativas, à Medicina Tradicional Chinesa (MTC) e à Osteopatia, promovendo um profundo reequilíbrio do organismo de dentro para fora.",
                )}
              </p>
              <p>
                {t(
                  "A beleza exterior e a estética avançada surgem assim não como o foco único, mas como a consequência natural e visível de um corpo curado, desintoxicado e em plena harmonia. Cada protocolo que desenvolvo respeita a individualidade biológica, garantindo resultados sustentáveis e transformadores.",
                )}
              </p>
            </div>
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div
                  key={idx}
                  className="flex flex-col gap-2 rounded-sm border border-gold-soft/30 bg-background/50 p-4 transition-colors hover:border-gold/60"
                >
            ...
            <Link
              to="/sobre"
              className="mt-10 inline-flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-primary hover:text-gold"
            >
              {t("Conhecer a minha história")}{" "}
              <ArrowRight className="h-4 w-4" strokeWidth={1.5} />
            </Link>
      ...
      <section className="bg-background py-24 md:py-32 border-b border-border/50">
        <div className="container-narrow">
          <SectionHeading
            ...
            title={
              <>
                {t("Presença na")} <em className="text-gold">{t("Europa")}</em>
              </>
            }
            description={t(
            ...
            {[
              {
                ...
                desc: "Lisboa, Porto, Algarve e Caldas da Rainha. Tratamentos faciais e corporais com acompanhamento premium.",
              },
              {
                name: "França",
                flag: "https://flagcdn.com/w160/fr.png",
                desc: "Paris e Lyon. Consultas exclusivas de estética avançada e rejuvenescimento.",
              },
              {
                name: "Espanha",
                flag: "https://flagcdn.com/w160/es.png",
                desc: "Madrid e Barcelona. Drenagem linfática integrativa e protocolos pós-operatórios.",
              },
              {
                name: "Bélgica",
                flag: "https://flagcdn.com/w160/be.png",
                desc: "Bruxelas. Terapias de desintoxicação e equilíbrio corporal completo.",
              },
              {
                name: "Croácia",
                flag: "https://flagcdn.com/w160/hr.png",
                desc: "Zagreb. Protocolos exclusivos de estimulação e revitalização da pele.",
              },
              {
                name: "Países Baixos",
                flag: "https://flagcdn.com/w160/nl.png",
                desc: "Amsterdã. Programas personalizados de Hidrolinfa e desintoxicação iónica.",
              },
              {
                name: "Itália",
                flag: "https://flagcdn.com/w160/it.png",
                desc: "Roma e Milão. Tratamentos corporais esculpidos e terapias de relaxamento profundas.",
              },
              {
                name: "Alemanha",
                flag: "https://flagcdn.com/w160/de.png",
                desc: "Berlim e Munique. Tecnologia de ponta para resultados estéticos de excelência.",
              },
              {
                name: "Reino Unido",
                flag: "https://flagcdn.com/w160/gb.png",
                desc: "Londres. Consultas personalizadas e acompanhamento dedicado de alta performance.",
              },
            ].map((c) => (
              <div
                key={c.name}
            ...
            {[
              {
                ...
                text: "Uma conversa detalhada para entender as suas necessidades, historial clínico e objetivos.",
              },
              {
                step: "02",
                title: "Plano à Medida",
                text: "Desenho de um protocolo de tratamentos personalizado, combinando as melhores técnicas para si.",
              },
              {
                step: "03",
                title: "Acompanhamento",
                text: "Monitorização contínua dos resultados e ajustes no plano para garantir a máxima eficácia e satisfação.",
              },
            ].map((p, i) => (
              <div
                key={i}
                className="relative flex flex-col items-start bg-background md:px-6 md:-mx-6"
              >
                <span className="flex h-16 w-16 items-center justify-center rounded-full bg-cream font-serif text-2xl text-gold border border-border/50 shadow-sm">
                  {p.step}
                </span>
            ...
            <div className="md:w-1/3">
              <SectionHeading
                ...
                title={
                  <>
                    {t("Dúvidas")}{" "}
                    <em className="text-gold">{t("frequentes")}</em>
                  </>
                }
              />
