              ...
              <div className="absolute -bottom-6 -left-6 flex flex-col sm:flex-row gap-4">
                ...
                <div className="bg-background border border-border p-4 sm:px-6 shadow-sm flex items-center gap-4 hidden sm:flex">
                  ...
                  <div>
                    ...
                    <p className="font-serif font-medium text-primary mt-0.5">
                      {service.sessionsRecommendation}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  {service.benefits.map((b) => (
                    ...
                    >
                      <Check
                        className="mt-0.5 h-4 w-4 text-gold shrink-0"
                        strokeWidth={2}
                      />
                      {b}
                    </li>
      ...
      <section className="bg-cream py-24 md:py-32">
        <div className="container-narrow">
          <SectionHeading
            ...
            title={
              <>
                Potencialize resultados com os nossos{" "}
                <em className="text-gold">packs</em>.
              </>
            }
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            {services
              ...
              .map((rs) => (
                <article
                  key={rs.slug}
                  className="group relative border border-border/50 bg-background p-6 transition-all hover:border-gold/40 hover:shadow-sm"
                >
                  <div className="flex flex-col sm:flex-row gap-6">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <Link
                        to="/servicos/$slug"
                        params={{ slug: rs.slug }}
                        className="mt-4 inline-flex items-center gap-2 text-[10px] uppercase tracking-widest text-gold hover:text-primary transition-colors"
                      >
